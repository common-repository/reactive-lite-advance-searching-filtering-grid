...
class Re_Admin {
  ...
  public function re_admin_menu() {
    ...
    add_menu_page( $page_title = 'Reactive Templates(Pro)', $menu_title = 'Reactive Templates(Pro)', $capability = 'manage_options', $menu_slug = 'reactive_templates', $function =  array( $this , 're_admin_templates_options'),$icon_url = 'dashicons-screenoptions', 87 );

    add_submenu_page( $parent_slug = 'reactive_admin', $page_title = 'Geobox(Pro)', $menu_title='Geobox(Pro)', $capability = 'manage_options', $menu_slug = 'reactive_geobox', $function = array($this , 're_admin_geobox') );
    add_submenu_page( $parent_slug = 'reactive_admin', $page_title = 'Settings(Pro)', $menu_title='Settings(Pro)', $capability = 'manage_options', $menu_slug = 'reactive_settings', $function = array($this , 're_admin_settings') );

    add_submenu_page( $parent_slug = 'reactive_admin', $page_title = 'Meta Restrictions(Pro)', $menu_title='Meta Restrictions(Pro)', $capability = 'manage_options', $menu_slug = 'meta_restrictions', $function = array($this , 're_admin_meta_restrictions') );
