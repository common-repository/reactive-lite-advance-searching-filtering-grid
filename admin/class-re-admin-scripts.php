...
class Re_Admin_Scripts{
  ...
  //  add_filter('reactive_generator_localize_args', array($this, 'reactive_generator_localize_args_func' ));
    ...
    if($info->post_type === 'reactive_grid' || $info->post_type === 'reactive_category' || $info->post_type === 'reactive_map_marker' || $info->post_type === 'reactive_map_info' || $info->post_type === 're_preview_popup' || $info->post_type === 're_grid_shortcode'){
