...
<div class="adminContainer">
  <h1>Welcome to Reactive Lite</h1>
  <span>v2</span>
</div>
<div class="adminContainer">
  <div class="adminGrid">
    <h2>Reactive Pro Version </h2>
    <div class="gridContent"><p>Check out the pro version</p></div>
    <a href="https://codecanyon.net/item/reactive-pro-advanced-wordpress-search-filtering-grid/17425763?ref=redqteam" target="_blank" class="addonsBttn">Reactive Pro</a>
  </div>
  <div class="adminGrid">
    <h2>Reactive Documentation</h2>
